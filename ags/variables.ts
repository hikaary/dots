...
export const current_wallpaper = Variable(`${GLib.get_home_dir()}/.config/wallpapers/old.png`);
...
export const settings_file = `${GLib.get_home_dir()}/.config/.settings/settings.json`;
