...
map("n", "<leader>h", "", "TODO: Define functionality")
map("n", "<leader>v", "", "TODO: Define functionality")
...
-- Git
map("n", "<leader>lg", "<cmd>LazyGit<CR>", "Toggle Neogit")
...
map(
  "v",
  "<leader>pt",
  ":PrtRewrite Сгенерируй юнит-тесты (pytest)<CR>",
