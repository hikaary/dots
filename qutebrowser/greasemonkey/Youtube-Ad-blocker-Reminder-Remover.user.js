  ...
  function checkForUpdate() {
    ...
    fetch(scriptUrl)
      ...
      .then((data) => {
        ...
        console.log(
          "Remove Adblock Thing: A new version is available. Please update your script. " +
            githubVersion +
            " : " +
            currentVersion,
        );
        ...
        if (updateModal.enable) {
          ...
          if (
            parseFloat(
              localStorage.getItem("skipRemoveAdblockThingVersion"),
            ) === githubVersion
          ) {
            return;
          }
