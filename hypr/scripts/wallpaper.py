...
parser.add_argument(
    '-n', '--notify', help='Send notifications', action='store_true'
)
parser.add_argument(
...
async def main():
    ...
    new_wallpaper = f'{HOME}/.config/wallpapers/lake.png'

    if random:
        files = [
            f
            for f in os.listdir(f'{HOME}/wallpaper')
    ...
    if wallpaper_engine == 'swww':
        ...
        hyprpaper_conf_file = os.path.expanduser(
